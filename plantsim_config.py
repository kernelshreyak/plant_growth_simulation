...
CYCLES = 100                # Number of discrete growth iterations (time steps) to simulate
...
BRANCH_PROB = 0.2          # Probability that an active branch tip will bifurcate each cycle
...
BASE_ROOT_LEN = 1.3       # Base segment length; scaled by local soil moisture
...
FLOWER_CYCLE_START = 88    # Cycle after which flowers begin to appear on new branch tips
